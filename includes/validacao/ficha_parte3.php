    ...
    $_POST['carisma']
        ...
        $_POST['carisma'] 
               ...
               $dados = " ";
                ...
                $comandoSQL = "CALL SP_INSERT_PERSONAGEM_P3 ($codigo_personagem,$forca,$destreza,$constituicao,$inteligencia,
                $sabedoria,$carisma,$combobox1,$combobox2);";

               $dados = $conn->query($comandoSQL);
               $dados = " ";
               
                header('Location: ../../cadastro_parte4.php');
